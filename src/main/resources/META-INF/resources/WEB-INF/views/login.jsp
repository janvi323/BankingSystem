...
<div class="login-container">
    ...
    <!-- Show Logout Message Only if logout succeeded -->
    ...
    <div style="text-align: center; margin: 20px 0;">
        <p>Or sign in with:</p>
        <a href="/oauth2/authorization/google" class="btn btn-oauth">Google</a>
    </div>
    ...
    <div class="api-info">
        ...
        <ul>
            ...
            <li><strong>GET /api/customers</strong> – List Customers</li>
